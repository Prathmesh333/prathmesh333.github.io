...
- **Cyberpunk Effects**: 
  ...
  - Electric arc effects between letters
  - Glitch text animations
  - 3D floating geometric shapes in menu
...
├── three-background.js     # Three.js particle background
├── Prathamesh_Nikam_Resume.pdf
└── *.png                   # Project images
```
...
- **Projects**: Showcase of ML/AI projects with live demos
...
```bash
git clone https://github.com/Prathmesh333/prathmesh333.github.io.git
```
